...
public class ModLanguageProvider extends AbstractLanguageProvider {
    ...
    protected void addTranslations(TranslationBuilder builder) {
        ...
        builder.add(KeyMappingHandler.KEY_TOGGLE_FAST_PLACEMENT, "Toggle Fast Placement");
        builder.add(KeyMappingHandler.KEY_FAST_PLACEMENT_MESSAGE, "Fast Placement: %s");
    }
}
