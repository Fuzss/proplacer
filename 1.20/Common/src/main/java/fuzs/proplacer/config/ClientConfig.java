...
public class ClientConfig implements ConfigCore {
    @Config(
            description = {
                    "Allow using Bedrock Edition-like fast block placement, with blocks being placed without leaving gaps or unwanted placements. Also enables placing blocks when clicking in mid-air.",
    ...
    @Config(description = "Is fast block placement enabled by default in-game. Toggle in-game via the dedicated key binding.")
    public boolean defaultFastPlacement = true;
